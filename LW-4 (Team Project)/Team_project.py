...
# 11. Replace the word "research" with "studies" "Sukov Mykola (studen4)"
replaced_text = text.replace('research', 'studies')
print("Text after replacement:\n", replaced_text)

# 12. Count the number of words "Sukov Mykola (studen4)"
words = text.split()
word_count = len(words)
print("Number of words in the text:", word_count)

# 13. Reverse the text "Sukov Mykola (studen4)"
